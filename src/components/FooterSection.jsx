...
const FooterSection = () => {
  return (
    <footer className="footer footer-center bg-base-200 text-base-content rounded p-10">
      ...
      <nav className="grid md:grid-flow-col gap-4 *:font-body">
      ...
      <div>
        <p className="font-body">info@contact.com</p>
        <p className="font-body">+1-234-56789</p>
      </div>
      <aside>
        <p className="font-logo">
          Copyright © {new Date().getFullYear()} - All right reserved by CRUD STORE
        </p>
      </aside>
    </footer>
  );
